...
readers="READER_NAGRA READER_IRDETO READER_CONAX READER_CRYPTOWORKS READER_SECA READER_VIACCESS READER_VIDEOGUARD READER_DRE READER_TONGFANG READER_STREAMGURAD READER_BULCRYPT READER_GRIFFIN READER_DGCRYPT"
...
menu_readers() {
	${DIALOG} --checklist "\nChoose readers (CA systems):\n " $height $width $listheight \
		...
		READER_STREAMGURAD	"Streamguard"		$(check_test "READER_STREAMGURAD") \
